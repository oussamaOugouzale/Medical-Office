(function ($) {
    ...
    $(window).resize(function () { if ($('.content').length > 0) { resizeInnerDiv(); } }); if ($('.owl-carousel.special').length > 0) { $('.owl-carousel.special').owlCarousel({ loop: true, margin: 15, dots: true, nav: false, smartSpeed: 2000, responsive: { 0: { items: 1 }, 500: { items: 2 }, 768: { items: 3 }, 1000: { items: 4 }, 1300: { items: 4 } } }) }
    ...
    if ($('.owl-carousel.eye-blogslider').length > 0) { $('.owl-carousel.eye-blogslider').owlCarousel({ loop: true, margin: 15, dots: true, nav: false, smartSpeed: 2000, responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 4 } } }) }
    ...
    if ($('.owl-carousel.patient-review-slider').length > 0) { $('.owl-carousel.patient-review-slider').owlCarousel({ loop: true, margin: 15, dots: true, nav: false, smartSpeed: 2000, navText: ['<i class="fa-solid fa-arrow-left"></i>', '<i class="fa-solid fa-arrow-right"></i>'], responsive: { 0: { items: 1 }, 1300: { items: 1 } } }) }
    ...
    if ($('.owl-carousel.our-slider-thirteen').length > 0) { $('.owl-carousel.our-slider-thirteen').owlCarousel({ loop: true, margin: 24, dots: true, nav: false, smartSpeed: 2000, responsive: { 0: { items: 1 }, 500: { items: 1 }, 575: { items: 2 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 3 } } }) }
    ...
    if ($('.owl-carousel.team-fourteen-slider').length > 0) { $('.owl-carousel.team-fourteen-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 4 } } }) }
    if ($('.owl-carousel.blog-slider-fourteen').length > 0) { $('.owl-carousel.blog-slider-fourteen').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 575: { items: 2 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 3 } } }) }
    ...
    if ($('.owl-carousel.banner-sliderssurgery').length > 0) {
        var brandSlider = $('.banner-sliderssurgery'); brandSlider.owlCarousel({ loop: true, margin: 0, dots: false, nav: false, autoplay: true, items: 4.5, smartSpeed: 500, center: true, responsive: { 0: { items: 1 }, 500: { items: 1 }, 575: { items: 2 }, 768: { items: 3 }, 1000: { items: 4.5 }, 1300: { items: 4.5 } } })
        function brandSliderClasses() { brandSlider.each(function () { var total = $(this).find('.owl-item.active').length; $(this).find('.owl-item').removeClass('activeset'); $(this).find('.owl-item').removeClass('activeset'); $(this).find('.owl-item.active').each(function (index) { if (index === 2) { $(this).addClass('activeset') } }) }) }
        brandSliderClasses(); brandSlider.on('translated.owl.carousel', function (event) { brandSliderClasses() });
    }
    if ($('.owl-carousel.treatment-sixteen-slider').length > 0) { $('.owl-carousel.treatment-sixteen-slider').owlCarousel({ loop: true, margin: 24, dots: true, nav: false, smartSpeed: 2000, responsive: { 0: { items: 1 }, 500: { items: 1 }, 575: { items: 2 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 4 } } }) }
    ...
    if ($(' #slide-experts').length > 0) { $('#slide-experts').owlCarousel({ margin: 0, center: true, loop: true, nav: true, dots: false, navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 768: { items: 2, margin: 15, }, 1000: { items: 3, } } }); }; if ($('.owl-carousel.feedback-slider-fourteen').length > 0) { $('.owl-carousel.feedback-slider-fourteen').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 1 }, 1000: { items: 1 }, 1300: { items: 1 } } }) }
    if ($('.owl-carousel.feedback-review-slider').length > 0) { $('.owl-carousel.feedback-review-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 1 }, 1000: { items: 1 }, 1300: { items: 1 } } }) }
    ...
    if ($('.blogs-three').length > 0) { $('.blogs-three .blogs').owlCarousel({ loop: true, margin: 15, dots: false, nav: true, navContainer: '.slide-nav-4', navText: ['<i class="fas fa-chevron-left custom-arrow"></i>', '<i class="fas fa-chevron-right custom-arrow"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 } } }) }
    ...
    $(window).scroll(function () { var sticky = $('.header'), scroll = $(window).scrollTop(); if (scroll >= 150) sticky.addClass('pharmacy-header'); else sticky.removeClass('pharmacy-header'); }); $(window).on('load resize', function () {
    ...
    }); if ($('.swiper-slider-banner').length > 0) { var swiper = new Swiper(".swiper-slider-banner", { effect: "cards", grabCursor: true, initialSlide: 2, loop: false, rotate: true, mousewheel: { invert: false, }, }); }
    if ($('.popular-test-slider').length > 0) { $('.popular-test-slider').owlCarousel({ loop: false, margin: 15, dots: true, nav: false, smartSpeed: 2000, responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 4 } } }) }
    if ($('.doctor-consulting-slider').length > 0) { $('.doctor-consulting-slider').owlCarousel({ loop: false, margin: 15, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-play"></i>', '<i class="fa-solid fa-play"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 1300: { items: 1 } } }) }
    if ($('.feature-package-slider').length > 0) { $('.feature-package-slider').owlCarousel({ loop: false, margin: 15, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-play"></i>', '<i class="fa-solid fa-play"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 3 } } }) }
    if ($('.best-package-slider').length > 0) { $('.best-package-slider').owlCarousel({ loop: false, margin: 15, dots: true, nav: false, smartSpeed: 2000, responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 2 }, 1200: { items: 3 } } }) }
    if ($('.booking-lab-test-slider').length > 0) { $('.booking-lab-test-slider').owlCarousel({ loop: false, margin: 15, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-play"></i>', '<i class="fa-solid fa-play"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 2 }, 1200: { items: 3 } } }) }
    if ($('.popular-choice-slider').length > 0) { $('.popular-choice-slider').owlCarousel({ loop: false, margin: 15, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-play"></i>', '<i class="fa-solid fa-play"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1200: { items: 4 } } }) }
    if ($('.nurse-profile-slider').length > 0) { $('.nurse-profile-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.nurse-slide-nav', navText: ['<i class="fa-solid fa-chevron-left"></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1200: { items: 3 } } }) }
    if ($('.top-nurse-profile-slider').length > 0) { $('.top-nurse-profile-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.top-nurse-slide-nav', navText: ['<i class="fa-solid fa-chevron-left"></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1200: { items: 3 } } }) }
    if ($('.blog-slide-fourteen').length > 0) { $('.blog-slide-fourteen').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.blog-slide-nav', navText: ['<i class="fa-solid fa-chevron-left"></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1200: { items: 3 } } }) }
    if ($('.various-logo-slider').length > 0) { $('.various-logo-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: false, smartSpeed: 2000, autoplay: true, responsive: { 0: { items: 1 }, 500: { items: 2 }, 768: { items: 3 }, 1000: { items: 5 }, 1200: { items: 6 } } }) }
    if ($('.work-video-img').length > 0) { $('.work-video-img').slick({ slidesToShow: 1, slidesToScroll: 1, arrows: true, fade: true, asNavFor: '.slider-thumbnails-img' }); }
    if ($('.slider-thumbnails-img').length > 0) { $('.slider-thumbnails-img').slick({ slidesToShow: 3, slidesToScroll: 1, asNavFor: '.work-video-img', dots: false, arrows: false, centerMode: false, focusOnSelect: true }); }
    $('.treatment-video a').on('click', function () {
        var currentVideo = $(this).parent().find(".doctor-treatment-video").get(0); var allVideos = $(".doctor-treatment-video"); $(this).parent().find(".doctor-treatment-video").toggleClass('active'); $(this).toggleClass('active'); allVideos.each(function () {
            if (currentVideo != this)
                this.pause();
        }); if (currentVideo.paused) { currentVideo.play(); } else { currentVideo.pause(); }
    }); $(function () { $("#table-filter").on("click", function (a) { $(".form-sorts").toggleClass("table-filter-show"); a.stopPropagation() }); $(document).on("click", function (a) { if ($(a.target).is(".form-sorts") === false) { $(".form-sorts").removeClass("table-filter-show"); } }); }); $('.filter-dropdown-menu').click(function (event) { event.stopPropagation(); }); if ($('.select-img').length > 0) {
        function formatState(state) {
            if (!state.id) { return state.text; }
            var $state = $('<span><img src="' + $(state.element).attr('data-image') + '" class="clinic-img" / " width="32px"> ' + state.text + '</span>'); return $state;
        }; $('.select-img').select2({ minimumResultsForSearch: Infinity, templateResult: formatState, templateSelection: formatState });
    }
    if ($('.select-social-img').length > 0) {
        function formatState(state) {
            if (!state.id) { return state.text; }
            var $state = $('<span><img src="' + $(state.element).attr('data-image') + '" class="social-img" / " width="16px"> ' + state.text + '</span>'); return $state;
        }; $('.select-social-img').select2({ minimumResultsForSearch: Infinity, templateResult: formatState, templateSelection: formatState });
    }
    if ($('.flag-img').length > 0) {
        function formatState(state) {
            if (!state.id) { return state.text; }
            var $state = $('<span><img src="' + $(state.element).attr('data-image') + '" class="flag-img" / " width="16px"> ' + state.text + '</span>'); return $state;
        }; $('.flag-img').select2({ minimumResultsForSearch: Infinity, templateResult: formatState, templateSelection: formatState });
    }
    if ($('.stripe-box').length > 0) { $(".stripe-box").on('click', function () { $(".stripe-box").removeClass('active'); $(this).addClass('active'); }); }
    ...
    $(".add-social-media").on('click', function () {
        var servcontent = '<div class="social-media-links d-flex align-items-center">' +
            ...
            '</div>' +
            '</div>'; $('.social-media-form').append(servcontent); if ($('.select-social-img').length > 0) { $('.select-social-img').select2({ minimumResultsForSearch: -1, width: '100%' }); }
        return false;
    }); $(".start-appointment-set").on('click', '.trash', function () { $(this).closest('.medication-wrap').remove(); return false; }); $(".add-medical").on('click', function () {
        var servcontent = '<div class="col-md-12">' +
            ...
            '</div>' +
            '</div>'
        $('.meditation-row').append(servcontent); if ($('.select').length > 0) { $('.select').select2({ minimumResultsForSearch: -1, width: '100%' }); }
        return false;
    }); $('.chat-search-btn').on('click', function () { $('.chat-search').addClass('visible-chat'); }); $('.close-btn-chat').on('click', function () { $('.chat-search').removeClass('visible-chat'); }); $(".chat-search .form-control").on("keyup", function () { var value = $(this).val().toLowerCase(); $(".chat .chat-body .messages .chats").filter(function () { $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1) }); }); $(".left_sides").on('click', function () { if ($(window).width() <= 991) { $('.sidebar-group').removeClass('hide-left-sidebar'); $('.sidebar-menu').removeClass('d-none'); } }); $(".left_sides").on('click', function () { if ($(window).width() <= 991) { $('.chat-messages').removeClass('show-chatbar'); } }); $(".user-list li a").on('click', function () { if ($(window).width() <= 991) { $('.left-sidebar').addClass('hide-left-sidebar'); $('.sidebar-menu').addClass('d-none'); $('.chat').addClass('show-chatbar'); } }); if ($('.tab-items').length > 0) { const tabLinks = document.querySelectorAll('.tab-link'); const tabContents = document.querySelectorAll('.tab-items'); tabLinks.forEach(tabLink => { tabLink.addEventListener('click', () => { const tabId = tabLink.getAttribute('data-tab'); tabLink.classList.toggle('active'); $('.tab-items.acive input').prop('disabled', false); const tabContent = document.getElementById(tabId); tabContent.classList.toggle('active'); }); }); }
    if ($('.appointment-calender-slider').length > 0) { $('.appointment-calender-slider').owlCarousel({ loop: true, margin: 5, dots: false, nav: true, navContainer: '.slide-nav', navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 2 }, 500: { items: 2 }, 768: { items: 5 }, 1000: { items: 4 }, 1300: { items: 5 } } }) }
    if ($('.past-appointments-slider').length > 0) { $('.past-appointments-slider').owlCarousel({ loop: true, margin: 5, dots: false, nav: true, navContainer: '.slide-nav2', navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 1300: { items: 1 } } }) }
    if ($('.owl-carousel.slider-service').length > 0) { $('.owl-carousel.slider-service').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 } } }) }
    if ($('.owl-carousel.doctor-slider-ten').length > 0) { $('.owl-carousel.doctor-slider-ten').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1400: { items: 4 }, 1300: { items: 3 } } }) }
    if ($('.owl-carousel.testimonial-sliders').length > 0) { $('.owl-carousel.testimonial-sliders').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 } } }) }
    if ($('.owl-carousel.blog-slider').length > 0) { $('.owl-carousel.blog-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 } } }) }
    if ($('.owl-carousel.fertility-slider').length > 0) { $('.owl-carousel.fertility-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 768: { items: 2 }, 1000: { items: 3 }, 1300: { items: 3 } } }) }
    if ($('.owl-carousel.insurence-logo-slider').length > 0) { $('.owl-carousel.insurence-logo-slider').owlCarousel({ loop: false, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.slide-1', navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 2 }, 768: { items: 3 }, 1000: { items: 5 }, 1300: { items: 6 } } }) }
    if ($('.owl-carousel.treatment-slider').length > 0) { $('.owl-carousel.treatment-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.slide-nav-02', navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 1 }, 1200: { items: 2 }, 1300: { items: 2 } } }) }
    if ($('.owl-carousel.partners-sliders').length > 0) { $('.owl-carousel.partners-sliders').owlCarousel({ loop: true, margin: 24, nav: false, autoplay: true, smartSpeed: 2000, responsive: { 0: { items: 1 }, 550: { items: 1 }, 700: { items: 4 }, 1000: { items: 6 } } }) }
    if ($('.owl-carousel.availability-slots-slider').length > 0) { $('.owl-carousel.availability-slots-slider').owlCarousel({ loop: false, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.slide-2', navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 2 }, 768: { items: 3 }, 1000: { items: 5 }, 1300: { items: 6 }, 1400: { items: 7 } } }) }
    if ($('.owl-carousel.expert-slider').length > 0) { $('.owl-carousel.expert-slider').owlCarousel({ loop: true, margin: 24, nav: false, dots: false, autoplay: true, smartSpeed: 2000, navContainer: '.slide-nav-01', navText: ['<i class="fas fa-chevron-left"></i>', '<i class="fas fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 550: { items: 1 }, 700: { items: 2 }, 1000: { items: 3 }, 1300: { items: 4 } } }) }
    if ($('.owl-carousel.awards-slider').length > 0) { $('.owl-carousel.awards-slider').owlCarousel({ loop: false, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.slide-3', navText: ['<i class="fa-solid fa-chevron-left "></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 768: { items: 1 }, 1000: { items: 2 }, 1300: { items: 4 }, 1400: { items: 4 } } }) }
    if ($('.dentist-slider').length > 0) { $('.dentist-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.blog-nav', navText: ['<i class="fa-solid fa-chevron-left"></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 768: { items: 1 }, 1000: { items: 2 }, 1300: { items: 3 }, 1400: { items: 3 } } }) }
    $(".information-title-list li").on('click', function () { $(this).addClass("active").siblings().removeClass('active'); }); if ($('.customer-slider').length > 0) { $('.customer-slider').owlCarousel({ loop: true, margin: 24, dots: false, nav: true, smartSpeed: 2000, navContainer: '.customer-nav', navText: ['<i class="fa-solid fa-chevron-left"></i>', '<i class="fa-solid fa-chevron-right"></i>'], responsive: { 0: { items: 1 }, 500: { items: 1 }, 768: { items: 2 }, 992: { items: 3 }, 1200: { items: 3 } } }) }
})(jQuery);